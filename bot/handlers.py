...
#     message = bot.send_message(message.chat.id, text="Fetching comments...")
...
def send_welcome(message):
    ...
    try:
        ...
        #             bot.send_message(message.chat.id, text="Story bookmarked")
        #         else:
        ...
        bot.send_message(message.chat.id, text=f"An error occurred")
        return
...
#         bot.send_message(message.chat.id, text="An error occurred")
...
#         args = get_args(message.text)
#         if not args:
#             bot.send_message(message.chat.id, text="Please provide a story id")
#             return

#         bot.send_message(message.chat.id, text="Bookmarking story...")
#         iid = args[0]
#         if not iid.isdigit():
#             bot.send_message(message.chat.id, text="Please provide a valid story id")
#             return
...
#             if not res:
#                 bot.send_message(message.chat.id, text="No bookmarks found")
#                 return
...
#         args = get_args(message.text)
#         if not args:
#             bot.send_message(message.chat.id, text="Please provide a bookmark id")
#             return
...
#         bot.send_message(message.chat.id, text="Bookmark deleted")
...
#         args = get_args(message.text)
#         if not args:
#             bot.send_message(message.chat.id, text="Please provide a page size")
#             return
...
#                     return
#         except ValueError:
#             bot.send_message(message.chat.id, text="Please provide a valid number")
#             return
#         except Exception as e:
#             bot.send_message(message.chat.id, text=f"An error occurred: {str(e)}")
#             return

#         bot.send_message(message.chat.id, text="Page size set")
#     except Exception as e:
